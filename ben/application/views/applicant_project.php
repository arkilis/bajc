...
<title>BAJC - Project Reports Submission</title>
...
<script type="text/javascript">
        ...
        /*
            type1:      upload type (EOI, proposal, project reports), no use
      ...
      function ajaxFileUpload(type1, type2, fileid2, field, msg){  
          ...
          $.ajaxFileUpload({
              url:'<?php echo base_url();?>/recvProject.php',
...
<div id="bodyPan"><!--style="border: black solid 1px"-->
  ...
  <div id="rightPan">
    <h2>Project Reports Submission</h2>
    <hr />
    <?php
        $this->load->helper('form');
        echo form_open('applicant/addProjectUser');
    ?>
    <table style="width:500px;">
        <tr>
            <td>Proposal Title:</td>
            <td><input type="text" name="ProjectTitle" value="<?php echo($ay_res[3]); ?>"/>*</td>
            <td class="error"><?php echo form_error('ProjectTitle'); ?></td>
        </tr>
        <tr>
        ...
        -->
        <tr>
            <td>Upload Project Report 1:</td>
            <td>
				<input type="file" id="word_doc" name="word_doc" />
				<a href="javascript:void(0)" onclick="return ajaxFileUpload('Project','doc','word_doc','word_doc', 'word_msg', 'msg1');">Add</a>
			</td>
            <td></td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Upload Project Report 2:</td>
            <td>
				<input type="file" id="pdf_doc" name="pdf_doc" />
				<a href="javascript:void(0)" onclick="return ajaxFileUpload('Project','pdf','pdf_doc', 'pdf_doc', 'pdf_msg', 'msg2');">Add</a>
			</td>
            <td></td>
        </tr>
        <tr>
