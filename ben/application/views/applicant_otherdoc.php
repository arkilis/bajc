...
<div id="bodyPan"><!--style="border: black solid 1px"-->
  ...
  <div id="rightPan">
    ...
    <?php
        ...
        {
            echo("<tr>");
            echo("<td style='width:100px;'>".$elm[0]."</td>");
            $path= base_url();
            echo("<td style='width:100px;'><a href='../../../".substr($elm[1],9)."'>Download</a></td>");
            echo("<td style='width:100px;'>".$elm[2]."</td>");
            echo("</tr>");
        }
